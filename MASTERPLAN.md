...
Nächster Schritt: **AP 1.3** (Inhalte für L11 Sonderzeichen + L12 Sonnen-/Mondbuchstaben — größte verbleibende fachliche Lücke) und/oder **AP 1.4/1.5** (Schreibtrainer 2.0, Silbentraining) und/oder **AP 1.6** (Stufenprüfung 2.0, jetzt auf den 12 Lektionen aufbauend).
