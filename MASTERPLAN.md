...
Nächster Schritt: **AP 2.2 fortsetzen** — die zurückgestellte Content-Erweiterung (bestehende 5 Dialoge auf 10–14 Zeilen, 7 neue Dialoge: Im Restaurant · Auf dem Markt · Beim Arzt · Die Uhrzeit · Am Telefon · Der Weg zur Moschee · Beim Nachbarn), danach AP 2.3 (Satzbau-Übung als eigener Übungstyp — teilweise durch die jetzige Kachel-Satz-Frage vorweggenommen, aber laut Plan als eigenständiger, aus Beispielsätzen generierter Fragetyp gedacht).
